      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 gap-16">
        ...
        <section>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="w-full h-100 bg-zinc-900 border border-zinc-800 rounded-sm relative overflow-hidden group"
          >
            {/* Placeholder Image Area */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-zinc-800 to-black opacity-50" />
            ...
            {/* Overlay UI */}
            <div className="absolute bottom-0 left-0 w-full p-6 bg-linear-to-t from-black via-black/80 to-transparent flex flex-col md:flex-row justify-between items-end">
              <div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-8">
           ...
           <div className="md:col-span-8">
              <motion.div 
                className="group relative h-full min-h-75 bg-zinc-900 border border-zinc-800 p-8 flex items-center justify-center overflow-hidden cursor-crosshair transition-colors hover:border-zinc-600"
